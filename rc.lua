...
beautiful.init("/home/avd/.config/awesome/themes/orange/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "a", function () mymainmenu:show({keygrabber=true}) end),
    ...
    awful.key({ modkey, "Control" }, "y", awesome.restart),
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "y",      function (c) c:redraw()                       end),
