...
\begin{picture}(297,210)
	\put(10,200){
		\begin{minipage}[t]{85mm}
			...
			%B1 on tag\dots{}View tag\\
			%B4 on tag\dots{}Switch to previous tag\\
			%B5 on tag\dots{}Switch to next tag\\
			%B4 on root window\dots{}Switch to previous tag\\
			%B5 on root window\dots{}Switch to next tag\\
			%B1, B3, B3, B4 on layout symbol\dots{}Switch layout\\
